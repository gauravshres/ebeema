...
<!-- 
						   <span  ng-model="value1"> {{sa1}}</span> -->
												   ...
												   <label>
												    	...
												    	<input type="checkbox" ng-model="vm" ng-change="oncheckpwb(vm)">PWB
												    </label>
												    <label>
												    	<input type="checkbox" id="advanced-list" value="checked"> ADB
												    </label>
												     <label>
												    	<input type="checkbox" id="advanced-list" value="checked"> MIB
												    </label>
							 				</form>	
						</div>
